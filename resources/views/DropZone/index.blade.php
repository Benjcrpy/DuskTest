    ...
    <body>
        <div class="container mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="drop-zone" class="drop-zone border">
                        <span>Drag and drop some file here or select files </span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                function uploadedImages(files, index) {
                        ...
                        return;
                    {
                        ...
                        $.ajax({
                            ...
                            xhr: function() {
                                var xhr = new window.XHLHttpRequest();
